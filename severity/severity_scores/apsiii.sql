...
DROP table IF EXISTS public.APSIII CASCADE;
CREATE table public.APSIII as
with bg as
(
  ...
  from public.kentran_bloodgasfirstdayarterial bg
  left join public.kentran_2_1_ventdurations vd
...
(
  ...
  from icustays ie
  left join public.kentran_uofirstday uo
    on ie.icustay_id = uo.icustay_id
  left join public.kentran_labsfirstday labs
...
left join public.kentran_ventfirstday vent
  on ie.icustay_id = vent.icustay_id
left join public.kentran_gcsfirstday gcs
  on ie.icustay_id = gcs.icustay_id
left join public.kentran_vitalsfirstday vital
