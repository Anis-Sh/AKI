...
DROP table IF EXISTS public.SOFA CASCADE;
CREATE table public.SOFA AS
with wt AS
(
...
, echo2 as(
  ...
  from icustays ie
  left join public.kentran_echodata echo
...
left join public.kentran_vitalsfirstday v
  on ie.icustay_id = v.icustay_id
left join public.kentran_labsfirstday l
