...
DROP MATERIALIZED VIEW IF EXISTS public.kentran_bloodgasfirstdayarterial CASCADE;
CREATE MATERIALIZED VIEW public.kentran_bloodgasfirstdayarterial AS
with stg_spo2 as
(
...
select bg.*
  ...
  , s1.spo2
from public.kentran_bloodgasfirstday bg
