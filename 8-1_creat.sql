...
from (
	select icustay_id
		...
		, case
			...
			when (creat.date_creat-creat.admittime) between '24:00:00' and '48:00:00'  then 2
			when (creat.date_creat-creat.admittime) between '48:00:00' and '72:00:00' then 3
			when (creat.date_creat-creat.admittime) between '72:00:00' and '96:00:00'  then 4
			when (creat.date_creat-creat.admittime) between '96:00:00' and '120:00:00' then 5
			else null
		end as day
	from(
